...
const values = [
  {
    title: 'Réactivité',
    desc: "Intervention en moins d'une heure, 24h/24 et 7j/7, sans surcoût le week-end.",
    icon: (
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer staggerDelay={0.1} className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: 'Sans surcoût',
                desc: 'Tarifs identiques de jour comme de nuit, week-end et jours fériés inclus.',
                icon: (
