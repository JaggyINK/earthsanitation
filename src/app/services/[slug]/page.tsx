    ...
    <>
      ...
      {service.intro && (
        <section className="py-14 lg:py-18 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeInUp>
              <p className="text-lg sm:text-xl text-sage leading-relaxed text-center">
                {service.intro}
              </p>
            </FadeInUp>
          </div>
              ...
              {service.sections.map((section, i) => (
                <FadeIn key={i} delay={i * 0.15}>
                  <div className="relative bg-white rounded-2xl border border-sand/40 p-8 h-full group hover:shadow-lg hover:border-forest/20 transition-all duration-300">
                    ...
                    <h3 className="text-xl font-heading font-bold text-forest mt-3 mb-4">
                      {section.title}
                    </h3>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {service.tips.map((tip, i) => (
                <StaggerItem key={i}>
                  <div className="flex gap-4 bg-cream/50 rounded-xl p-5 hover:bg-cream/80 transition-colors duration-300">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <StaggerContainer className="space-y-4">
              {service.faq.map((item, i) => (
                <StaggerItem key={i}>
                  <details className="group bg-white border border-sand/50 rounded-xl overflow-hidden">
