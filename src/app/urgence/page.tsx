...
export default function UrgencePage() {
  return (
    <>
      <section className="bg-red-600 text-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href={PHONE_HREF}
            className="inline-flex items-center gap-3 bg-white text-red-600 font-bold text-2xl px-10 py-5 rounded-xl hover:bg-cream transition-colors shadow-lg"
          >
