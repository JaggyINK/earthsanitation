...
import { COMPANY_NAME, getWhatsAppUrl } from '@/lib/utils'
import { services } from '@/data/services'
import { useSiteSettings } from '@/contexts/SiteSettingsContext'

export default function Footer() {
  const { phoneNumber, companyEmail, whatsappNumber } = useSiteSettings()
  return (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 flex flex-col gap-2 lg:hidden">
              <a href={getWhatsAppUrl({ type: 'general', whatsappNumber })} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-cream hover:text-gold transition-colors text-sm">
              ...
              <a href={`mailto:${companyEmail}`} className="flex items-center gap-2 text-cream/70 hover:text-cream transition-colors text-sm">
                <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden lg:block">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li>
                <a href={getWhatsAppUrl({ type: 'general', whatsappNumber })} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-cream hover:text-gold transition-colors">
              ...
              <li>
                <a href={`mailto:${companyEmail}`} className="flex items-center gap-2 text-cream/70 hover:text-cream transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
                    <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
                  </svg>
